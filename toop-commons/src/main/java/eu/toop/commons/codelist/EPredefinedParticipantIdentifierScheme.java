...
public enum EPredefinedParticipantIdentifierScheme implements IPredefined
{
   ...
   * SIRENE - <code>0002</code> Scheme agency: Institut National de la
   * Statistique et des Etudes Economiques, (I.N.S.E.E.)<br>
   * Structure of the code: 1) Number of characters: 9 characters
   * (&quot;SIREN&quot;) 14 &quot; 9+5 (&quot;SIRET&quot;), The 9 character
   * number designates an organization, The 14 character number designates a
   * specific establishment of the organization designated by the first 9
   * characters. 2) Check digits: 9th &amp; 14th character respectively<br>
   ...
   * @since code list v1
   */
  FR_SIRENE ("System Information et Repertoire des Entreprise et des Etablissements: SIRENE",
             "0002",
             "FR",
             Version.parse ("1"),
             false,
  ...
  /**
   * Organisationsnummer - <code>0007</code> Scheme agency: The National Tax
   * Board<br>
   * Structure of the code: 1) 10 digits. 1st digit = Group number, 2nd - 9th
   * digit = Ordinalnumber1st digit, = Group number, 10th digit = Check digit,
   * 2) Last digit.<br>
  ...
  /**
   * SIRET-CODE - <code>0009</code> Scheme agency: DU PONT DE NEMOURS<br>
  ...
  /**
   * LY-tunnus - <code>0037</code> Scheme agency: National Board of Taxes,
   * (Verohallitus)<br>
   * Structure of the code: 1) ICD 4 Digits, Organization code upto 11
   * characters, Organization name upto 250 characters, 2) None - Example:
   * 00371234567800001 - 0037 Country code for Finland (ISO 6523 International
   * Code Designator (ICD) value) - 12345678 Business ID without hyphen - 00001
   * Optional specifier for organisation unit (assigned by the organisation
   * itself)<br>
  ...
  /**
   * Data Universal Numbering System (D-U-N-S Number) - <code>0060</code> Scheme
   * agency: Dun and Bradstreet Ltd<br>
   * Structure of the code: 1) 8 digits, 1st-7th digit = number, 8th digit =
   * check number, 2) digit<br>
  ...
  /**
   * Global Location Number - <code>0088</code> Scheme agency: GS1 GLN<br>
   * Structure of the code: 1) Eight identification digits and a check digit. A
   * two digit prefix will be added in the future but it will not be used to
   * calculate the check digit. 2) The Organization name is not part of the
   * D-U-N-S number.<br>
  ...
  /**
   * DANISH CHAMBER OF COMMERCE Scheme - <code>0096</code> Scheme agency: Danish
  ...
  /**
   * FTI - Ediforum Italia - <code>0097</code> Scheme agency: FTI - Ediforum
   * Italia<br>
   * Structure of the code: Character repertoire, The EDI identifier consists of
   * digits only. The identifier has a fixed length. No separators are required.
   * Structure: [123] [123456] [123456] [12], 17, &lt; &gt;, A B C D, A:
   * numerical value allocated by the RA to the regional sub-authority, (3
   * digits), B: numerical value allocated by the sub-authority to the
   * registered organization (mandatory part of the identifier; 6 digits), C:
   * numerical value used by the registered organization (free part; 6 digits),
   * D: numerical check digit calculated by the registered organization; (2
   * digits), Check digit computation, The check digit is modular 97 computed on
   ...
   * of Chambers of Commerce and Industry in the Netherlands), Scheme -
   * <code>0106</code> Scheme agency: Vereniging van Kamers van Koophandel en
   * Fabrieken in Nederland<br>
   * 
   * @since code list v1
   */
  ...
  /**
   * Directorates of the European Commission - <code>0130</code> Scheme agency:
   * European Commission, Information Directorate, Data Transmission Service<br>
  ...
  /**
   * SIA Object Identifiers - <code>0135</code> Scheme agency: SIA-Società
   * Interbancaria per l'Automazione S.p.A.<br>
  ...
  /**
   * SECETI Object Identifiers - <code>0142</code> Scheme agency: Servizi
   * Centralizzati SECETI S.p.A.<br>
   * Structure of the code: First field: ICD: 4 digits, Second field: sequence
   * of digits<br>
   * Display requirements: None<br>
   * 
   * @since code list v1
  ...
  /**
   * DIGSTORG - <code>0184</code> Scheme agency: DIGSTORG<br>
  ...
  /**
   * Organisatie Indentificatie Nummer (OIN) - <code>0190</code> Scheme agency:
   * Logius<br>
   * 
   * @since code list v1
   */
  ...
  /**
   * Company code - <code>0191</code> Scheme agency: Centre of Registers and
   * Information Systems of the Ministry of Justice<br>
  ...
  /**
   * Organisasjonsnummer - <code>0192</code> Scheme agency: The Brønnøysund
   * Register Centre<br>
   * Structure of the code: 9 digits The organization number consists of 9
   * digits where the last digit is a control digit calculated with standard
   * weights, modulus 11. After this, weights 3, 2, 7, 6, 5, 4, 3 and 2 are
   * calculated from the first digit.<br>
   * Display requirements: None<br>
   * 
   * @since code list v1
   */
  ...
  /**
   * UBL.BE Party Identifier - <code>0193</code> Scheme agency: UBL.BE<br>
   * Structure of the code: Maximum 50 characters 4 Characters fixed length
   * identifying the type Maximum 46 characters for the identifier itself<br>
   * Display requirements: None<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Singaport Nationwide E-Invoice Framework - <code>0195</code> Scheme agency:
   * lnfocomm Media Development Authority<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Icelandic identifier - <code>0196</code> Scheme agency: Icelandic National
   * Registry<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Danish Ministry of the Interior and Health - <code>9901</code> Scheme
   * agency: Danish Ministry of the Interior and Health<br>
   * Structure of the code: 1) First field: ICD: 4 digits, Second field:
  ...
  /**
   * The Danish Commerce and Companies Agency - <code>9902</code> Scheme agency:
   ...
   * <code>9904</code> Scheme agency: Danish Ministry of Taxation, Central
  ...
  /**
   * Danish VANS providers - <code>9905</code> Scheme agency: Danish VANS
   * providers<br>
   * Usage information: DK26769388<br>
   * 
   * @since code list v2
  ...
  /**
   * Ufficio responsabile gestione partite IVA - <code>9906</code> Scheme
   * agency: Ufficio responsabile gestione partite IVA<br>
  ...
  /**
   * TAX Authority - <code>9907</code> Scheme agency: TAX Authority<br>
   * Usage information: RSSBBR69C48F839A NOTE: The &quot;CF&quot; is a Fiscal
   * Code that can be &quot;personal&quot; or for a &quot;legal entity&quot;.
  ...
  /**
   * Organisasjonsnummer - <code>9908</code> Scheme agency: Enhetsregisteret ved
   * Bronnoysundregisterne<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Hungarian VAT number - <code>9910</code> Usage information:
   * 990399123MVA<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Business Registers Network - <code>9913</code> Scheme agency: Business
   * Registers Network<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * IBAN - <code>9918</code> Scheme agency: SOCIETY FOR WORLDWIDE INTERBANK
   * FINANCIAL, TELECOMMUNICATION S.W.I.F.T<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Kennziffer des Unternehmensregisters - <code>9919</code> Structure of the
   * code: 9 characters in total; letter, number x3, letter, number x3,
   * letter<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Agencia Española de Administración Tributaria - <code>9920</code> Scheme
   * agency: Agencia Española de Administración Tributaria<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Indice delle Pubbliche Amministrazioni - <code>9921</code> Scheme agency:
   * Indice delle Pubbliche Amministrazioni<br>
   * 
   * @since code list v2
   */
  ...
  /**
   * Belgian Crossroad Bank of Enterprise number - <code>9956</code> Scheme
   * agency: Belgian Crossroad Bank of Enterprises <br>
   * Structure of the code: Format: 9.999.999.999 - Check: 99 = 97 -
   * (9.999.999.9 modulo 97)<br>
   * 
   * @since code list v2
   */
